...
export default async function ProjectPage({
  ...
  const descBlock = (
    ...
    >
      ...
      <ExpandableDesc text={project.long_desc || project.short_desc || ""} />
    </div>
  );
      ...
      >
        ...
        {project.client && (
          <div style={{ marginBottom: 12 }}>
            ...
            <p
              style={{ color: "var(--text)", fontSize: 14, margin: "2px 0 0" }}
            >
              {project.client}
            </p>
          </div>
      ...
      >
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            {project.short_desc && (
              <p
                style={{ color: "var(--text2)", fontSize: 18, lineHeight: 1.7 }}
              >
                {project.short_desc}
              </p>
            )}
          ...
          {/* Layout responsive : Stack → À propos → Infos sur mobile */}
          <ProjectLayout desc={descBlock} sidebar={sidebarBlock} />
